...
Listado.prototype.obtengoCiudad = function() {
...
Listado.prototype.obtengoRubro = function() {
    var rubros = [];
...
Listado.prototype.obtengoHorario = function() {
    //En este array se van a cargar los arrays de horarios, que luego vamos convertir en un solo array
    var arregloHorarios = [];
    this.restaurantes.map(x=>arregloHorarios.push(x.horario));
    ...
    var horariosSinRepetir = this.filtrarRepetidos(horarios);
...
Listado.prototype.filtrarRepetidos= function(array){
    var resultadoFiltro=array.filter((elemento, index, self)=>{
