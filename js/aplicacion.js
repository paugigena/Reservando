...
Aplicacion.prototype.dibujarCiudades = function() {
    ...
    this.listado.obtengoCiudad().forEach(function(ciudad) {
...
Aplicacion.prototype.dibujarRubros = function() {
    ...
    this.listado.obtengoRubro().forEach(function(rubro) {
...
Aplicacion.prototype.dibujarHorarios = function() {
    ...
    this.listado.obtengoHorario().forEach(function(horario) {
